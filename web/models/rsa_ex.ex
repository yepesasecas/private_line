defmodule RsaEx do
  ...
  def generate_private_key do
    ...
    {raw_key, _} = System.cmd "openssl", [ "genrsa", "2048"], [stderr_to_stdout: true]
    [_, key] = String.split(raw_key, "-----BEGIN RSA PRIVATE KEY-----")
    priv = "-----BEGIN RSA PRIVATE KEY-----#{key}"
    # {_, 0} = System.cmd "openssl", [ "genrsa", "2048"], [stderr_to_stdout: true]
